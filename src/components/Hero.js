        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a className="btn btn-outline dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-gray-900" href="#footer">联系我们</a>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                ...
                <h3 className="text-2xl font-bold text-primary dark:text-white mb-2">电子连接解决方案</h3>
