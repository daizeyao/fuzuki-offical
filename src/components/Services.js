...
const servicesList = [
  {
    title: '售前服务',
    description: '我们的客服团队和销售工程师随时为您解答疑问，提供详细的产品信息、技术参数和选型建议，帮助您快速找到最适合的产品。',
    features: ['专业咨询', '方案定制'],
    icon: 'fa-comments'
  },
  {
    title: '售中服务',
    description: '我们拥有完善的订单处理系统，能够快速响应您的订单需求，确保产品及时准确地发货，让您尽快收到所需产品。',
    features: ['快速响应', '物流跟踪'],
    icon: 'fa-money-check-alt'
  },
  {
    title: '售后服务',
    description: '在产品使用过程中，如果您遇到任何技术问题，我们的专业技术人员将为您提供及时、有效的技术支持，通过线上、电话、邮件等方式，帮助您快速解决问题。',
    features: ['技术支持', '质量保障'],
    icon: 'fa-headset'
  }
];
