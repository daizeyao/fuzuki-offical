    ...
    >
      <div className="container flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center space-x-8">
          ...
          <a href="/products" className="text-gray-700 dark:text-gray-300 hover:text-secondary transition-colors">产品展示</a>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden lg:block">
            <a className="btn" href={TAOBAO_URL} target="_blank" rel="noopener noreferrer">立即下单</a>
          </div>
