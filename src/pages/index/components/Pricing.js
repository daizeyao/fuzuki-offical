    ...
    <section id="pricing" className="py-20 dark:bg-gray-900">
      <div className="container">
        ...
        >
          ...
          <p className="text-base md:text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">富崎电子始终坚持以合理的价格为您提供高品质的产品和服务。我们深知，价格是客户选择产品的重要因素之一，因此我们通过优化生产流程、严格控制成本，努力为您提供更具性价比的产品。
          </p>
