        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-5xl xl:text-6xl xl:leading-tight font-bold text-primary dark:text-white mb-10">
              {intl.formatMessage({ id: 'hero.headline' })}
            </h1>
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-center">
                  {intl.formatMessage({ id: 'hero.card.description' })}
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mt-8 w-full max-w-xs">
                  <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg text-center">
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      {intl.formatMessage({ id: 'hero.card.sold' })}
                    </div>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg text-center">
                    <div className="text-xl font-bold text-primary dark:text-white">98%</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      {intl.formatMessage({ id: 'hero.card.satisfaction' })}
                    </div>
                  </div>
                </div>
              </div>
