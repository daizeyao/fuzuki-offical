...
const products = [
  {
    image: [require('@/assets/products_img/A828.png'), require('@/assets/products_img/KJ118.png')],
    title: '工业级面板接口',
  ...
  {
    image: [require('@/assets/products_img/MSDD08.png'), require('@/assets/products_img/MSDD228M.png')],
    title: '面板式全金属网口',
